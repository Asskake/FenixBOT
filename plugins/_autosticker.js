...
handler.all = async function(m) {
  ...
  if (chat.autosticker && m.isGroup) {
    ...
    if (/image/g.test(mime)) {
      ...
      if (/video/g.test(mime)) if ((q.msg || q).seconds > 8) return await m.reply(`*[❗𝐈𝐍𝐅𝐎❗] VIDEO TIDAK BOLEH LEBIH DARI 7 DETIK\n\nUNTUK MENONAKTIFKAN OPTION INI (#𝚍𝚒𝚜𝚊𝚋𝚕𝚎 𝚊𝚞𝚝𝚘𝚜𝚝𝚒𝚌𝚔𝚎𝚛)`);
