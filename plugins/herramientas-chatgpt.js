...
const handler = async (m, {conn, text, usedPrefix, command}) => {
  ...
  if (!text) throw `*[❗] Masukkan permintaan atau pesanan untuk menggunakan fungsi chatgpt*\n\n*—◉ contoh permintaan dan perintah*\n*◉ ${usedPrefix + command} Siapa Nabi Muhammad SAW*\n*◉ ${usedPrefix + command} Apa Alkitab Nabi Muhammad SAW*`;
  try {
